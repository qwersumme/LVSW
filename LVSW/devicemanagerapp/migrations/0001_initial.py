...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BarcodeEvent',
            fields=[
                ('barcode', models.OneToOneField(db_column='Barcode', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='devicemanagerapp.barcodeelement')),
            ],
            options={
